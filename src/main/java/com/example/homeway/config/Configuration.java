        ...
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/v1/customer/offer/accept/*","/api/v1/customer/offer/reject/*","/api/v1/customer/ai/ServiceEstimator/*","/api/v1/customer/review-assist/*","/api/v1/customer/customer/report-summary/*",
                                ...
                                ,"/api/v1/review/customer/**","/api/v1/subscription/**").hasAuthority("CUSTOMER")
                        //customer ^
                        .requestMatchers("/api/v1/company/inspection/**","/api/v1/workers/**").hasAuthority("INSPECTION_COMPANY")
                        .requestMatchers("/api/v1/company/moving/**","/api/v1/vehicle/**","/api/v1/workers/**").hasAuthority("MOVING_COMPANY")
                        .requestMatchers("/api/v1/company/maintenance/**","/api/v1/company/maintenance/**","/api/v1/workers/**").hasAuthority("MAINTENANCE_COMPANY")
                        .requestMatchers("/api/v1/company/redesign/**","/api/v1/workers/**").hasAuthority("REDESIGN_COMPANY")
                        //each company ^
